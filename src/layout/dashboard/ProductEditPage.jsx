...
import { getallCategories, update } from '../../features/productapi';
      ...
      <div className='flex mx-20 mt-14 justify-between'>
        ...
        <div className='flex flex-col w-[70%]'>
          <div className='flex justify-between items-center w-[100%]'>
            ...
            <button className='flex items-center w-32 h-8 justify-center outline-none border-none text-white bg-red-800 rounded-3xl'>
              Delete
            </button>
          </div>
